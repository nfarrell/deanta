...
using BoafyAuth.Admin.ExceptionHandling;
using BoafyAuth.Admin.Middlewares;
using BoafyAuth.Admin.Configuration;
using BoafyAuth.Admin.Configuration.ApplicationParts;
using BoafyAuth.Admin.Configuration.Constants;
using BoafyAuth.Admin.Configuration.Interfaces;
using Skoruba.IdentityServer4.Admin.EntityFramework.Interfaces;
using BoafyAuth.Admin.Helpers.Localization;

namespace BoafyAuth.Admin.Helpers
{
