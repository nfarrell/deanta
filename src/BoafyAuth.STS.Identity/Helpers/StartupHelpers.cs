...
using SendGrid;
using Serilog;
using BoafyAuth.STS.Identity.Configuration;
using BoafyAuth.STS.Identity.Configuration.ApplicationParts;
using BoafyAuth.STS.Identity.Configuration.Constants;
using BoafyAuth.STS.Identity.Configuration.Intefaces;
using BoafyAuth.STS.Identity.Helpers.Localization;
using BoafyAuth.STS.Identity.Services;
using ILogger = Microsoft.Extensions.Logging.ILogger;

namespace BoafyAuth.STS.Identity.Helpers
{
